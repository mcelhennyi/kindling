...
description: "Read-only security analysis for a repo, design, service, dependency set, container image, protocol, or feature, including current CVE/advisory checks for the languages, packages, products, and protocols in scope."
---
