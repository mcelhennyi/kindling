---
name: "source-command-commit-with-metrics"
...
# source-command-commit-with-metrics

Use this skill when the user asks to run the migrated source command `commit-with-metrics`.
