---
name: "source-command-identify-frontier"
description: "Writes tasks/handoffs/YYYY-MM-DD-parallel-frontier.md from ticket-progress, tasks/feature-history/**/tickets.md, and tickets-initial DAG. For full steps, follow the project skill identify-frontier."
---

# source-command-identify-frontier

Use this skill when the user asks to run the migrated source command `identify-frontier`.
