...
> **Status (2026-05-21):** `@kindling/mantle` v0 is being authored under hearth FR-0006. Until v0 ships, the React template will pin a workspace pre-release; the Python template's `web/dist/index.html` includes raw tokens inline.
